...
print('In total you have ',hours_rem,'hours, equal to seeing ',int(hours_rem/3),'movies of 3hrs or complete',int(hours_rem/24),'days for your work!! Get up and do some shit.')
